        ...
        questions
            ...
            .forEach((question, index) => {
                ...
                divQuestion.className =
                    "min-h-[100px] overflow-x-auto text-blue-700 w-[450px]";
                ...
                deleteButton.className =
                    "bg-red-600 text-white hover:bg-red-700 mt-2 px-2 m-1 rounded-full p-2 text-sm font-semibold";
    ...
    form?.addEventListener("submit", async (e) => {
        ...
        if (questions.length === 0) {
            return Swal.fire({
                ...
                title: "Oops...",
                confirmButtonColor: "#d33",
                title: "Por favor, agrega al menos una pregunta",
            });
        }
        ...
        try {
            ...
            window.location.href = "/edas/questionnaires-templates";
        } catch (error) {
            console.error(error);
            Toast.fire({
                icon: "error",
