    ...
    <section class="max-w-xl p-10 mx-auto w-full">
        ...
        @if ($can_edit)
            <form method="POST" id="editcolab" action="/colaborador/{{ $colaboradorForm->id }}" role="form">
                ...
                <button type="submit"
                    class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center :bg-blue-600 :hover:bg-blue-700 :focus:ring-blue-800">Actualizar</button>
            </form>
        @else
