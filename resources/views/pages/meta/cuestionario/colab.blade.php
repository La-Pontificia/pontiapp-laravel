<button {{ !$cerrado ? 'disabled' : '' }} data-modal-target="cuestionario-modal" data-modal-toggle="cuestionario-modal"
    ...
    <div class="flex gap-3 items-center w-full">
        ...
        <div>
            <h1 class="text-neutral-800 text-base font-medium">Colaborador</h1>
    ...
    <div class="relative max-w-xl w-full max-h-full">
        ...
        <div class="relative bg-white rounded-2xl shadow">
            ...
            <header class="py-5 border-b text-center text-lg font-semibold">
                Cuestionario del Colaborador
            </header>
            <div class="px-4 py-4">
                @if ($cuestionarioColab)
                    <div class="flex flex-col divide-y">
                        @foreach ($cuestionarioColab->cuestionarioPreguntas as $index => $item)
                            <div class="py-3">
                ...
                @elseif (!$cuestionarioColab && $miPerfil)
                    ...
                    <footer>
                        <button id="submit-btn-colab" type="button" data-id="{{ $edaSeleccionado->id }}"
...
@section('script')
    <script>
        var respuestas = [];
        document.getElementById('submit-btn-colab').addEventListener('click', function() {
            var textareas = document.querySelectorAll('#list-question-colab textarea');
