...
@section('app')
    <div style="" id="app" class="h-screen">
        ...
        @else
            ...
            @endphp
            <div style="" id="app" class="h-screen">
                <nav class="fixed pl-[250px] max-sm:pl-0 border-b :border-gray-700 w-full border-gray-200 backdrop-blur-md z-30">
                    ...
                    <div class="h-full px-3 py-5 pt-2 flex flex-col overflow-y-auto bg-[#020b0f] shadow-lg">
                        <a href="/" class="flex  justify-center py-5 items-center">
                            <span class="w-36 block text-slate-200">
                                <svg version="1.0" viewBox="0 0 1483.000000 569.000000" preserveAspectRatio="xMidYMid meet">

                                    <g transform="translate(0.000000,569.000000) scale(0.100000,-0.100000)" fill="currentColor"
                                        stroke="none">
