    ...
    <div class="py-4 z-30">
        <div class="flex items-center w-full">
            <div class="flex relative group ">
                <div class="relative w-[5rem] h-[5rem] overflow-hidden min-w-[5rem] rounded-full">
            ...
            <div class="flex flex-col pl-2">
                <div class="flex gap-2 px-2 items-center justify-start">
                    <h3 class="text-lg font-bold capitalize text-gray-700">
                        {{ mb_strtolower($colaborador->nombres, 'UTF-8') }}
                        {{ mb_strtolower($colaborador->apellidos, 'UTF-8') }}
                    </h3>
                </div>
                <div class="bg-neutral-200 rounded-lg p-2">
                    <div class="text-gray-500 capitalize flex gap-1">
                        <svg viewBox="0 0 24 24" class="w-5 text-gray-500 " fill="none">
