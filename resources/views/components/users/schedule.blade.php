...
<div class="h-full rounded-2xl flex flex-col">
            ...
            <div class="relative p-4 w-full max-w-xl max-h-full">
                <div class="relative bg-white rounded-2xl shadow">
                    ...
                    <form action="" id="schedule-form" class="p-3 grid gap-4">
                        ...
                        <input value="Horario laboral" type="text" placeholder="Título (Opcional)" name="title">
                        <div class="flex items-center gap-2">
                            <div class="p-1">Inicia:</div>
                            <input required style="width: 170px" type="date" id="start-input" placeholder="Nombre"
                                name="start">
                        </div>
                        <div class="flex items-center gap-2">
    ...
    <div class="w-full h-full max-h-[600px]" id="calendar">
    </div>
</div>
