...
<nav
    class="flex-grow text-black flex flex-col p-3 pr-2 pt-0 text-sm [&>a]:flex [&>a]:items-center [&>a]:gap-2 [&>a]:p-2 [&>a]:rounded-lg hover:[&>a]:bg-white [&>a]:transition-colors [&>a>svg]:w-[15px] aria-selected:[&>a]:font-semibold aria-selected:[&>a]:text-indigo-600 [&>a>svg]:transition-transform 
