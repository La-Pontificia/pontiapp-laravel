                ...
                <div class="relative">
                    ...
                    @if ($cuser->has('users:edit') || $cuser->isDev())
                        ...
                        <div id="dropdown-{{ $schedule->id }}" class="dropdown-content hidden">
                            @if (($cuser->has('users:schedules:edit') && $schedule->user_id === $cuser->id) || $cuser->isDev())
                            ...
                            @endif
                            @if (($cuser->has('users:schedules:delete') && $schedule->user_id === $cuser->id) || $cuser->isDev())
                            ...
                            @endif
                            @if (($cuser->has('users:schedules:archive') && $schedule->user_id === $cuser->id) || $cuser->isDev())
