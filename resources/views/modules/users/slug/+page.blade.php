...
@section('layout.users.slug')
    <div class="p-4 flex flex-col flex-grow h-full">
        <div
            class="bg-white flex flex-col overflow-auto p-5 border-neutral-300 shadow-[0_0_10px_rgba(0,0,0,.2)] border rounded-xl h-full">
            <div class="p-4 space-y-2 flex h-full flex-col">
                <div class="flex-grow w-full">
                    @if ($hasChangePassword)
                        ...
                        @else
                            <button data-param="/api/users/reset-password/{{ $user->id }}"
                                data-atitle="Restablecer contraseña"
                    ...
                    @if ($cuser->has('users:edit') || $cuser->isDev())
                        <form id="form" class="grid gap-4 px-1 w-full dinamic-form" method="POST" role="form"
        ...
        @if ($cuser->has('users:edit') || $cuser->isDev())
            <div class="pt-4 border-t">
                <button type="submit" form="form" class="primary">
