            ...
            <div class="max-w-2xl mx-auto w-full flex-grow flex flex-col overflow-y-auto">
                <div class="flex items-center gap-3">
                    <div class="w-8 rounded-xl overflow-hidden aspect-square">
                        <img src={{ $cuser->profile }} class="w-full h-full object-cover" alt="">
                    </div>
                    <div>
                        <p class="text-sm">
                            {{ $cuser->last_name }},
                ...
                <form id="template-form" class="flex flex-col px-1 gap-4 overflow-y-auto w-full" role="form">
                    @include('modules.edas.questionnaires-templates.form', [
                        'template' => $template,
                    ])
                </form>
            </div>
        ...
        <div class="p-3 border-t border-neutral-300">
            <div class="max-w-2xl mx-auto flex gap-2">
                ...
                <button onclick="window.history.back()" type="button"
                    class="bg-white w-fit font-semibold hover:text-blue-600 text-black min-w-max flex items-center rounded-full p-2 gap-1 text-sm px-3">
                    Cancelar
                </button>
            </div>
        </div>
