...
@section('layout.edas')
    <div>
        <nav class="border-b p-2 flex gap-3">
            @if ($cuser->hasPrivilege('edas:questionnaires-templates:create'))
                <a href="/edas/questionnaires-templates/create"
                                ...
                                <tr
                                    ...
                                    <td>
                                        <div class="flex items-center gap-3">
                                            @if ($cuser->hasPrivilege('edas:questionnaires-templates:edit'))
                                                <a href="/edas/questionnaires-templates/{{ $template->id }}/questions"
                                            ...
                                            <div id="dropdown-template-{{ $template->id }}"
                                                ...
                                                <button data-alertvariant="warning" data-atitle="¿Usar cuestionario?"
                                                    ...
                                                    data-param="/api/questionnaires-templates/{{ $template->id }}/use"
