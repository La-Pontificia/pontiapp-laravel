        ...
        <div class="flex flex-grow gap-2 items-center">
            @if ($current_user->hasPrivilege('edas:create_all'))
                <button
                    ...
                    <span class="max-lg:hidden">Registrar eda</span>
                </button>
            @endif
            <div class="flex p-1 flex-grow gap-3 items-center">
                <label class="relative">
                    ...
                    <input value="{{ request()->query('q') }}" type="search" class="dinamic-search"
                        placeholder="Filtrar" style="padding-left: 40px;">
                </label>
                <div>
