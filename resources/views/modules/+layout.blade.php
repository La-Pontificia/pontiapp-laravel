        ...
        @else
            <div id="app" class="flex flex-col h-full flex-grow overflow-y-auto">
                ...
                <main class="flex h-full relative overflow-auto">
                    <aside id="sidebar"
                        class="flex peer flex-col max-lg:bg-[#fcfcfc] pt-4 max-lg:top-0 max-lg:pt-0 min-w-[300px] text-sm font-medium max-lg:-translate-x-full data-[expanded]:translate-x-0 max-lg:shadow-lg max-lg:fixed z-40 transition-all h-full overflow-y-auto">
                        <div class="p-5 pb-3 lg:hidden block">
                            <a href="/"><img src="/lp.webp" class="w-24" /></a>
                        </div>
                        <div class="flex-grow pr-2 overflow-y-auto transition-all">
