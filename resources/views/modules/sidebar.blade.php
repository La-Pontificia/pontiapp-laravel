    ...
    <nav class="py-2 border-t border-neutral-300 transition-all">
        @foreach ($otherItems as $item)
            ...
            <div class="sidebar-item group" {{ $item['active'] ? 'data-expanded' : '' }}>
                <button
                    class="flex sidebar-item-button group-data-[expanded]:bg-blue-50 transition-all w-full text-left relative items-center data-[active]:font-medium gap-3 p-2 px-5 text-[#202124] hover:bg-[#e8eaed] rounded-r-full">
                    @svg($item['icon'], 'w-5 h-5 m-0.5 opacity-70 group-data-[expanded]:text-blue-600 group-data-[expanded]:opacity-100')
                    <span class="text-nowrap">{{ $item['text'] }}</span>
                    ...
                    <div class="sidebar-item-content" {{ $item['active'] ? 'data-expanded' : '' }}>
                        @foreach ($item['subItems'] as $subItem)
                            ...
                            <a {{ $subItem['active'] ? 'data-active' : '' }}
                                class="flex group relative transition-all items-center data-[active]:font-medium data-[active]:text-[#1967da] gap-3 p-2 px-5 pl-8 text-[#202124] hover:bg-[#f4f5f7] rounded-r-full"
                                href="{{ $subItem['href'] }}">
