...
@section('content-sidebar')
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card card-default">
                    ...
                    <div class="card-body">
                        <form method="POST" id="sede-formulario" action="{{ route('sedes.store') }}" role="form"
    ...
    <script>
        ...
        const $formColaborador = document.getElementById("sede-formulario")
        // STORE 
        $formColaborador.addEventListener('submit', function(event) {
            ...
            axios.post(this.action, formData)
                .then(function(response) {
                    Swal.fire({
                        icon: 'success',
                        title: 'Sede creado correctamente!',
                    }).then(() => {
