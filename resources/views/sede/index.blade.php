...
@section('content-sidebar')
    ...
    @else
        <div class="max-w-3xl mx-auto w-full">
            <div class="py-3">
                <h1 class="font-semibold text-3xl">Gestión de sedes</h1>
                            ...
                            @foreach ($sedes as $index => $sede)
                                <tr class="border-b even:bg-gray-100 bg-white hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 font-medium whitespace-nowrap">
                                        {{ $sede->direccion }}</td>
                                    <td class="px6 -py-4">
                                        <button data-modal-target="{{ $sede->id }}-editar"
                                            data-modal-toggle="{{ $sede->id }}-editar"
                                            class="flex items-center gap-2 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
                                            type="button">
                                        ...
                                        <div id="{{ $sede->id }}-editar" data-modal-backdrop="static" tabindex="-1"
                                            aria-hidden="true"
                                                ...
                                                <div class="relative bg-white rounded-lg shadow">
                                                    ...
                                                    <div
                                                        ...
                                                        <button type="button"
                                                            ...
                                                            data-modal-hide="{{ $sede->id }}-editar">
                                                    ...
                                                    <form method="POST" action="{{ route('sedes.update', $sede->id) }}"
                                                        ...
                                                        <div
                                                            ...
                                                            <button data-modal-hide="{{ $sede->id }}-editar"
                                                                type="button"
        ...
        <div id="crear-modal" data-modal-backdrop="static" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative p-4 w-full max-w-xl max-h-full">
                <div class="relative bg-white rounded-lg shadow">
                    ...
                    <form class="create-form" method="POST" action="{{ route('sedes.store') }}" role="form"
