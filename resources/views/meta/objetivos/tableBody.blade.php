                            ...
                            <div class="relative bg-white rounded-2xl shadow dark:bg-gray-700">
                                ...
                                <div class="px-4 py-4">
                                    ...
                                    <form class="form-update-obj" method="POST"
                                        action="/meta/actulizar-objetivo/{{ $objetivo->id }}" role="form"
                                        ...
                                        <footer class="flex justify-end gap-2 mt-2 items-center">
                                            ...
                                            <button data-modal-target="editObjModal{{ $objetivo->id }}" type="button"
                                                type="button" data-modal-toggle="editObjModal{{ $objetivo->id }}"
