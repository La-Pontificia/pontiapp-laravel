        <div id="calificar-objs" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative max-w-screen-xl border rounded-xl shadow-xl bg-white w-full max-h-full">
                <!-- Modal content -->
                <button type="button"
                        ...
                        <tbody id="table-body-list" class="divide-y">
                            @foreach ($objetivos as $objetivo)
                                <tr class="border-b border-gray-200 divide-x text-sm ">
                                    <th scope="row"
                                        class="px-4 py-2 text-sm font-semibold text-blue-900 bg-gray-50 ">
