        ...
        <div>
            ...
            <div class="overflow-y-auto max-h-[60vh]">
                <table class="w-full text-sm text-left text-gray-500">
                    ...
                    <tbody id="table-body-list-calificacion" class="divide-y">
                            ...
                            <tr class="border-b border-gray-200 divide-x text-sm ">
                                ...
                                <td class="px-3 py-2 bg-gray-50 :bg-gray-800">
                                    <select name="nota" data-id="{{ $objetivo->id }}" required id="nota"
                                        ...
                                        <option {{ $promedio == 2 ? 'selected' : '' }} value="2">2
                                        </option>
                                        <option {{ $promedio == 3 ? 'selected' : '' }} value="3">3
                                        </option>
                                        <option {{ $promedio == 4 ? 'selected' : '' }} value="4">4
                                        </option>
                                        <option {{ $promedio == 5 ? 'selected' : '' }} value="5">5
                                        </option>
                                    </select>
                                </td>
                            </tr>
            ...
            <footer class="p-3 flex justify-end">
                <button id="guardar-calificacion_eva" data-id="{{ $id_eda }}" data-eva="{{ $n_eva }}"
