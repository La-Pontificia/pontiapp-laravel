            ...
            @if ($calificacion == 1)
                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <g id="SVGRepo_iconCarrier">
                        ...
                        <ellipse transform="matrix(0.2723 -0.9622 0.9622 0.2723 129.6514 329.347)" style="fill:#FCEB88;"
                            cx="282.569" cy="78.956" rx="29.854" ry="53.46">
                        </ellipse>
                    </g>
                </svg>
            @elseif($calificacion == 2)
                <svg version="1.1" id="Layer_1" viewBox="0 0 512.003 512.003" xml:space="preserve" fill="#000000">
                    <g id="SVGRepo_iconCarrier">
                        <circle style="fill:#FDDF6D;" cx="256.001" cy="256.001" r="256.001">
                        </circle>
                        <path style="fill:#FCC56B;"
