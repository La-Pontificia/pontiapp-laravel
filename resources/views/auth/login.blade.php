        ...
        <div class="min-h-svh max-sm:w-full text-gray-900 flex justify-center max-sm:justify-start">
            <div
                ...
                <div class="p-6 relative z-10 w-[450px] max-sm:w-full max-w-full  ">
                    <div class="w-full">
                        <h1 class="text-2xl pb-3 text-center font-semibold tracking-tight">
                            Centro de Administración de Edas y Asistencias.
                        </h1>
                        <div class="w-full">
                ...
                <div class="flex items-center justify-center w-full max-md:p-5 p-10 gap-10">
                    <img src="/elp.webp" class="h-8" />
                    <img src="/ilp.webp" class="h-8" />
                    <img src="/ec.webp" class="h-8 invert" />
                </div>
            </div>
