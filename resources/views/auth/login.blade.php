...
@section('content')
    <section class="">
        <div class="min-h-svh max-sm:w-full text-gray-900 flex max-sm:justify-start">
            <div class="flex h-full w-full">
                <div style="background-image: url(/background.jpg)" class="w-full min-h-svh bg-center max-lg:hidden bg-cover">
                </div>
                <div
                    class="flex flex-col flex-grow max-sm:w-full gap-4 relative sm:rounded-lg items-center max-sm:justify-start max-sm:items-start">
                    <div class="flex-grow flex flex-col justify-center">
                        <div class="p-10 relative z-10 w-[500px] max-sm:w-full max-w-full  ">
                            <div class="w-full">
                        ...
                        <div class="flex items-center justify-center w-full max-md:p-5 p-10 gap-5">
