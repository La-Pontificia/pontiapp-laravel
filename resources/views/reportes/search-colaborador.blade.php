...
<div class="relative flex flex-col gap-3">
    <div class="flex gap-2">
        <div class="w-full relative">
            ...
            <div class="absolute w-full px-2 bg-white z-10 shadow-lg hidden rounded-xl mt-1 flex-col divide-y"
                id="list-colabs">
                <div class="p-10 grid place-content-center text-center text-neutral-400">
                    <svg class="w-5 mx-auto text-gray-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                        fill="none" viewBox="0 0 20 20">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="m19 19-4-4m0-7A7 7 0 1 1 1 8a7 7 0 0 1 14 0Z" />
                    </svg>
    ...
    @if ($colaborador)
        <div class="flex relative items-start gap-2 bg-slate-950 text-amber-50 p-3 rounded-3xl">
            ...
            <div class="flex flex-col">
                ...
                <span class="text-neutral-300"><b>Cargo:</b> {{ $colaborador->cargo->nombre }}</span>
        ...
        searchTimeout = setTimeout(async function() {
            ...
            response.data.forEach(function(colaborador) {
                ...
                button.addEventListener('click', function() {
                    handleSelectChange(colaborador.id, 'colaborador');
                });
