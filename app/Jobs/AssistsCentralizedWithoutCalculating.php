...
class AssistsCentralizedWithoutCalculating implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        Mail::raw('Hola, el reporte de Asistencias centralizadas ya está disponible. Puedes descargarlo desde el siguiente enlace: ' . $downloadLink, function ($message) use ($user) {
